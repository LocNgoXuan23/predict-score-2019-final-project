import csv
file = open("raw_data (1).txt", "r")
datas = file.read().split("\n")
file = open("clean_data.txt", encoding="utf8", mode="w")
...
for data in datas:
	...
	# replace special charanters in name and scores
	...
	with open("clean_data.txt", "a", encoding="utf-8", newline='') as file_csv:
